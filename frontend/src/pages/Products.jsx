...
const Products = () => {
  ...
  const televisionProducts = [
    ...
    // only keep this IF "tel4.jpeg" exists:
  ...
  return (
    <Layout>
      <div className="p-4 space-y-12">
        ...
        <ProductCarousel category="Fashion & Beauty" products={fashionProducts} />

        <ProductCarousel category="Smart Televisions" products={televisionProducts} />

        <ProductCarousel category="Smartphones" products={smartphoneProducts} />

        <ProductCarousel category="Tablets" products={tabletProducts} />
