        ...
        {products.map((item) => (
            ...
            <div className="bg-white shadow-lg rounded-xl p-3 overflow-hidden transition-all duration-300 hover:shadow-xl">
                ...
                <button
                    ...
                    transition-all duration-200 active:scale-95 hover:bg-blue-700"
                >
                    Add to Cart
                </button>

                <button className="flex-1 bg-green-600 text-white py-2 rounded-lg text-sm font-semibold
                    transition-all duration-200 active:scale-95 hover:bg-green-700">
                    Buy Now
                </button>
                </div>
            </div>
